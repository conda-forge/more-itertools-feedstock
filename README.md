...
Development: https://github.com/more-itertools/more-itertools

Documentation: https://more-itertools.readthedocs.io/en/latest/api.html
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=638&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/more-itertools-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `more-itertools` can be installed with `conda`:
...
```
mamba install more-itertools
```

It is possible to list all of the versions of `more-itertools` available on your platform with `conda`:
...
```
mamba search more-itertools --channel conda-forge
```
...
mamba repoquery search more-itertools --channel conda-forge

# List packages depending on `more-itertools`:
mamba repoquery whoneeds more-itertools --channel conda-forge

# List dependencies of `more-itertools`:
mamba repoquery depends more-itertools --channel conda-forge
```
